(function () {
  ...
  var kazakhOverrides = {
    metaTitle: "Бабаш Жукенов | Әулет шежіресі",
    metaDescription: "Бабаш Жукеновтің өмір жолына арналған бұл бет отбасылық суреттер, марапаттар мен мұрағат құжаттарының негізінде жинақталды.",
    brand: "Әулет мұрағаты",
    ...
    githubTokenHelp: "Бұл токен тек репозиторийге өзгеріс жазу үшін қажет. Ол тек осы құрылғыдағы браузерде сақталады.",
    statusView: "Қарау режимі",
    statusEditing: "Өңдеу режимі қосылды",
    ...
    heroEyebrow: "Отбасы жадында сақталған азаматтың ғұмыр жолына арналады",
    heroTitle: "Бабаш Жукенов",
    heroLead: "Бұл бет Бабаш Жукеновтің өмір жолын отбасылық суреттер мен сақталған құжаттар арқылы таныстырады. Мұнда соғыс кезеңінің ізі, ел алдындағы қызметі, қоғамдық еңбегі және ұрпаққа жеткен қадірлі есімі тоғысады.",
    heroCtaTimeline: "Өмір жолын қарау",
    heroCtaArchive: "Мұрағатты ашу",
    factBirthText: "мұрағаттағы туған жылы",
    factPartyText: "партияға өткен жылы",
    factAwardsText: "сақталған мерейтойлық марапаттар",
    heroPortraitAlt: "Бабаш Жукеновтің портреті",
    portraitNoteLabel: "Отбасылық сурет",
    portraitNoteSource: "Жеке отбасылық мұрағат",
    aboutEyebrow: "Ғұмырнамасы",
    aboutTitle: "Құжаттар сөйлеткен өмір жолы",
    aboutP1: "Сақталған деректерге сүйенсек, Бабаш Жукенов 1921 жылы дүниеге келген. Оның ғұмыры ел басына күн туған кезеңмен, кейінгі қоғамдық істермен және ел ішіндегі абыройлы қызметпен сабақтас. Отбасылық мұрағатта әскери билет, партия билеті, оқу куәліктері мен әр жылдары берілген марапат құжаттары сақталған.",
    aboutP2: "Бұл жинақ ресми деректерді ғана емес, адамның болмысын да аңғартады: байыпты портреттер, көпшілікпен түскен суреттер, мөрі мен қолтаңбасы қалған куәліктер. Мұның бәрі бір әулет үшін қастерлі естелікке айналған.",
    factWarTitle: "Соғыс дәуірінің куәсі",
    factWarBody: "Жеңіс мерекесіне арналған медальдар оның 1941-1945 жылдардағы тарихи кезеңмен тікелей байланысты екенін аңғартады.",
    factPublicTitle: "Қоғам ісіне араласуы",
    factPublicBody: "Партиялық құжаттар оның 1946 жылы партия қатарына қабылданғанын және кейін де ел ісінен шет қалмағанын көрсетеді.",
    factEducationTitle: "Білімі мен беделі",
    factEducationBody: "1951-1952 жылдары кешкі партия мектебін аяқтап, кейін дербес зейнеткер мәртебесіне ие болғаны құжаттардан көрінеді.",
    memoryPortraitAlt: "Бабаш Жукеновтің студиялық портреті",
    memoryQuote: "Адамның ғұмыры тек даталармен өлшенбейді. Ол ескі суреттердегі жанардан, қағазға басылған мөрден, отбасының құрметпен сақтаған естелігінен танылады.",
    timelineEyebrow: "Жылнама",
    timelineTitle: "Өмір жолының негізгі белестері",
    ...
    timelineSchoolTitle: "Партия мектебіндегі білімі",
    timelineSchoolBody: "Аудандық кешкі партия мектебін аяқтағаны жөніндегі куәлік оның қоғамдық-саяси даярлығын көрсетеді.",
    ...
    timelineAwardsTitle: "Ел құрметі мен марапаты",
    timelineAwardsBody: "Сақталған құжаттар арасында КСРО мен Қазақстан Республикасының мерейтойлық марапаттары, сондай-ақ Жуков медаліне қатысты деректер бар.",
    awardsEyebrow: "Марапаттары",
    awardsTitle: "Еңбегі мен абыройын айғақтайтын құжаттар",
    ...
    groupPhotoCaption: "Дәуірдің тынысын сездіретін көпшілік суреті.",
    partySchoolAlt: "Партия мектебін аяқтағаны туралы куәлік",
    partySchoolCaption: "1952 жылы берілген оқу куәлігі.",
    partyCardAlt: "Партия билеті",
    partyCardCaption: "1946 жылғы мүшелік дерегі көрсетілген партия билеті.",
    archivePortraitAlt: "Бабаш Жукеновтің есейген шағындағы портреті",
    archivePortraitCaption: "Мұрағатқа айрықша мән беріп тұрған жеке портрет.",
    earlyIdAlt: "Ескі куәлік пен фотосурет",
    earlyIdCaption: "Қолтаңбасы мен мөрі сақталған ертеректегі құжаттардың бірі.",
    footerText: "Бұл бет отбасылық мұрағат негізінде дайындалды. Қаласаңыз, оны қосымша деректермен, естеліктермен және туыстардың аты-жөнімен толықтыра аласыз."
  };
